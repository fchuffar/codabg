...
# + label="Submission - dependencies" tags=["remove_cell"]
if ( !exists(x = "params") ) {
    params                      <- NULL
}
...
# + label="Submission - configuration" echo=true results="verbatim"
    ##
...
# + label="Submission - Program" echo=true results="verbatim"
...
# + label="Submission - Results" echo=true results="verbatim"
    ##
...
# + label="Submission - program zip file" echo=true results="verbatim"
