...
#   - a function `program` with `data_train` and `data_test` as argument, containing teh code associated to your prediction.
...
# Participants have to make a zip file (no constrain on the namefile), with your results as a vector matrix inside a txt file named `results.txt`.
...
program <- function(data_train, data_test) {
    ...
    # use NULL model to predict for GENE001 expression
    m = lm(GENE001~1, data_train)
